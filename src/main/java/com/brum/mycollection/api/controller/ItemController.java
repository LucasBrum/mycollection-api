...
public class ItemController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Response<ItemResponse>> update(@PathVariable Long id, @RequestPart("item") ItemRequest itemRequest,
			@RequestPart(value = "coverImage", required = false) MultipartFile coverImageFile) throws IOException {
